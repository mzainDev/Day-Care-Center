        ...
        <div className="flex flex-col items-center gap-14 lg:flex-row-reverse">
          ...
          <div className="lg:w-1/2 lg:pr-10">
            ...
            <div className="grid grid-cols-1 gap-6 mt-10 sm:grid-cols-2">
              {[
                { icon: <Calendar className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "Daily", desc: "Staff and children reports" },
                { icon: <School className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "Rooms", desc: "Utilization summaries" },
                { icon: <FileText className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "Plans", desc: "Subscription details" },
                { icon: <Download className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "Export", desc: "Downloadable PDFs" }
              ].map((feature, index) => (

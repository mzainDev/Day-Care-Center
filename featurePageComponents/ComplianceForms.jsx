        ...
        <div className="flex flex-col items-center gap-14 lg:flex-row">
          ...
          <div className="lg:w-1/2 lg:pl-10">
            ...
            <div className="flex gap-4 mt-10">
              <Link
                href="#compliance"
                className="flex items-center px-6 py-2.5 text-sm font-semibold text-white bg-orange-600 rounded-lg shadow hover:bg-orange-700 transition"
              >
                Requirements
              </Link>
              <Link
                href="#demo"
                className="px-6 py-2.5 text-sm font-semibold text-orange-600 border border-orange-300 rounded-lg bg-white hover:border-orange-500 transition"
              >
                See Examples
              </Link>
            </div>

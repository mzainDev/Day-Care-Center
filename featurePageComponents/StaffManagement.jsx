        ...
        <div className="flex flex-col items-center gap-10 lg:flex-row">
          ...
          <div className="lg:w-1/2 lg:pl-10">
            ...
            <div className="grid grid-cols-1 gap-4 mt-8 sm:grid-cols-2">
              {[
                { icon: '👥', title: "Profiles", desc: "Complete staff profiles" },
                { icon: '📅', title: "Scheduling", desc: "Visual shift calendar" },
                { icon: '📊', title: "Analytics", desc: "Performance metrics" },
                { icon: '🔒', title: "Roles", desc: "Permission levels" }
              ].map((feature, index) => (

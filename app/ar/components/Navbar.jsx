        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center justify-between w-full pl-10">
            <div className="flex space-x-8 text-[#0f2c4f] font-medium">
              <Link href="/ar/features" className="relative py-2 group">
              ...
              <Link href="/ar/targetclients" className="relative py-2 group">
                <span className="relative z-10 transition-all duration-300 group-hover:text-[#1f8282]">
                  العملاء المستهدفون
                </span>
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-[#5fe4e4] origin-left transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-[cubic-bezier(0.65,0,0.35,1)]"></span>
              ...
              <Link href="/ar/contact" className="relative py-2 group">
                <span className="relative z-10 transition-all duration-300 group-hover:text-[#1f8282]">
                  اتصل بنا
                </span>
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-[#5fe4e4] origin-left transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-[cubic-bezier(0.65,0,0.35,1)]"></span>
              ...
              <Link href="/ar/registercenter" className="relative py-2 group">
                <span className="relative z-10 transition-all duration-300 group-hover:text-[#1f8282]">
                  سجّل مركزك
                </span>
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-[#5fe4e4] origin-left transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-[cubic-bezier(0.65,0,0.35,1)]"></span>
          ...
          {isMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg p-6 z-40 border-t">
              <div className="flex flex-col space-y-4">
                ...
                <Link href="/ar/features" className="py-3 px-4 font-medium text-[#1f8282] hover:pl-6 transition-all duration-300 hover:bg-[#f0fdfd] rounded-lg" onClick={() => setIsMenuOpen(false)}>
                  المميزات
                </Link>
                <Link href="/ar/targetclients" className="py-3 px-4 font-medium text-[#1f8282] hover:pl-6 transition-all duration-300 hover:bg-[#f0fdfd] rounded-lg" onClick={() => setIsMenuOpen(false)}>
                  العملاء المستهدفون
                </Link>
                <Link href="/ar/contact" className="py-3 px-4 font-medium text-[#1f8282] hover:pl-6 transition-all duration-300 hover:bg-[#f0fdfd] rounded-lg" onClick={() => setIsMenuOpen(false)}>
                  اتصل بنا
                </Link>
                <Link href="/ar/registercenter" className="py-3 px-4 font-medium text-[#1f8282] hover:pl-6 transition-all duration-300 hover:bg-[#f0fdfd] rounded-lg" onClick={() => setIsMenuOpen(false)}>
                  سجّل مركزك
                </Link>
                <button
                  onClick={switchToEnglish}

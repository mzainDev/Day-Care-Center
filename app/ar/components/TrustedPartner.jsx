...
const TrustedPartner = () => {
  ...
  const partners = [
    { id: 1, logo: '/seclogo/22.png', alt: 'شريك 1' },
    { id: 2, logo: '/seclogo/6.png', alt: 'شريك 2' },
    { id: 3, logo: '/seclogo/77.png', alt: 'شريك 3' },
    { id: 4, logo: '/seclogo/888.png', alt: 'شريك 4' }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            نتعاون مع قادة الصناعة لتقديم حلول رعاية أطفال استثنائية
          </p>
        </motion.div>

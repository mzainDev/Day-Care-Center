        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative overflow-hidden rounded-3xl bg-white bg-opacity-30 backdrop-blur-md border border-teal-200/50 shadow-[0_25px_80px_rgba(92,225,230,0.25)] transition-transform duration-300 hover:scale-105">
              <ExportedImage
                src="/images/ChatFeature.jpeg"
                alt="واجهة ميزة المحادثة"
                width={900}
                height={675}
          ...
          <div className="w-full lg:w-1/2 lg:pl-10">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              ميزة المحادثة السلسة
            </h2>

            <p className="text-lg text-gray-600 mb-8">
              تتيح صفحة المحادثة المدمجة للأولياء التواصل بسهولة مع طاقم المركز بما في ذلك المعلمين، والمربيات، والإداريين في مكان واحد.
            </p>
            ...
            <div className="space-y-6 mb-10">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">مراسلة فردية</h3>
                  <p className="text-gray-600">تواصل مباشرة مع الطاقم بشأن رعاية طفلك.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">التحدث مع المعلمين والمربيات</h3>
                  <p className="text-gray-600">ابقَ على اطلاع بأنشطة طفلك اليومية.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">التواصل مع الإدارة</h3>
                  <p className="text-gray-600">تواصل مع الإداريين للحصول على الدعم.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">خاص وآمن</h3>
                  <p className="text-gray-600">جميع الرسائل محفوظة بأمان.</p>
                </div>
              </div>
            </div>

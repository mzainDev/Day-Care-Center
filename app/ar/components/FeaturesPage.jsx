      ...
      <section className="pt-16 pb-12 px-4 max-w-6xl mx-auto relative">
        ...
        >
          <div className="inline-block bg-gradient-to-r from-blue-100 to-blue-50 rounded-full px-6 py-2 mb-6 border border-blue-200">
            <span className="text-blue-600 font-medium">الميزة الأساسية</span>
          </div>
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
            هي لوحة التحكم المركزية حيث تتوفر جميع البيانات المتعلقة بتوزيع الغرف، إدارة الموظفين، تقارير الأطفال، والاشتراكات.
          </p>
        </motion.div>
        ...
        >
          {[
            {
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="bg-white rounded-full p-1 h-8 w-8 text-[rgb(92,225,230)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              ),
              title: 'التحليلات الفورية',
              desc: 'عرض بيانات مباشرة للمؤشرات المهمة',
            ...
            },
            {
              ...
              desc: 'تحكم كامل في مهام الموظفين',
            ...
            },
            {
              ...
              desc: 'إنشاء تقارير وتحليلات تفصيلية',

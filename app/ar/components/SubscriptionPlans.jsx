        ...
        <div className="flex flex-col items-center gap-14 lg:flex-row">
          ...
          <div className="relative lg:w-1/2">
            <div className="relative overflow-hidden rounded-3xl bg-white bg-opacity-30 backdrop-blur-md border border-teal-200/50 shadow-[0_25px_80px_rgba(13,148,136,0.25)] transition-transform duration-300 hover:scale-105">
              <ExportedImage
                src="/features/subscriptionPlan-ar.png"
                alt="خطط الاشتراك"
                width={720}
                height={500}
          ...
          <div className="lg:w-1/2 lg:pl-10">
            ...
            <p className="mt-4 text-gray-600 text-lg">
              خطط مرنة تناسب احتياجات كل أسرة في رعاية الأطفال.
            </p>

            <div className="grid grid-cols-1 gap-6 mt-10 sm:grid-cols-2">
              {[
                { icon: <Calendar className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "المرونة", desc: "يومي / أسبوعي / شهري" },
                { icon: <Tag className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "العروض", desc: "خصومات وقسائم" },
                { icon: <FileText className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "الفوترة", desc: "تتبع مبسط" },
                { icon: <Users className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "الأسر", desc: "خطط مخصصة" }
              ].map((feature, index) => (

        ...
        <div className="flex flex-col items-center gap-14 lg:flex-row-reverse">
          ...
          <div className="lg:w-1/2 lg:pr-10">
            ...
            <p className="mt-4 text-gray-600 text-lg">
              واجهة متاحة لجميع المستخدمين بغض النظر عن اللغة.
            </p>

            <div className="grid grid-cols-1 gap-6 mt-10 sm:grid-cols-2">
              {[
                { icon: <Globe className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "ثنائي اللغة", desc: "العربية والإنجليزية" },
                { icon: <RefreshCw className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "تبديل", desc: "تبديل سلس بين اللغات" },
                { icon: <Smartphone className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "متسق", desc: "جميع الميزات مترجمة" },
                { icon: <Users className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "المستخدمون", desc: "الموظفون والأوصياء" }
              ].map((feature, index) => (

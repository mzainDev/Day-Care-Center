        ...
        <div className="flex flex-col items-center gap-14 lg:flex-row">
          ...
          <div className="lg:w-1/2 lg:pl-10">
            ...
            <p className="mt-4 text-gray-600 text-lg">
              تتبع فوري وتحديثات مباشرة للأطفال والموظفين.
            </p>

            <div className="grid grid-cols-1 gap-6 mt-10 sm:grid-cols-2">
              {[
                { icon: <Clock className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "تسجيل الدخول", desc: "إشعارات فورية" },
                { icon: <AlertTriangle className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "تنبيهات", desc: "متابعة الوصول المتأخر" },
                { icon: <TrendingUp className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "اتجاهات", desc: "تحليلات الحضور" },
                { icon: <FileText className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "تقارير", desc: "ملخصات مرئية" }
              ].map((feature, index) => (

        ...
        <div className="flex flex-col items-center gap-14 lg:flex-row">
          ...
          <div className="lg:w-1/2 lg:pl-10">
            ...
            <p className="mt-4 text-gray-600 text-lg">
              إدارة جميع المستندات المطلوبة للامتثال للمعايير التنظيمية.
            </p>

            <div className="grid grid-cols-1 gap-6 mt-10 sm:grid-cols-2">
              {[
                { icon: <FileText className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "المستندات", desc: "رفع وتتبع" },
                { icon: <Building className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "الحكومة", desc: "الشهادات" },
                { icon: <RefreshCw className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "المتابعات", desc: "فحوصات السلامة" },
                { icon: <Folder className="w-6 h-6" style={{ color: 'rgb(92, 225, 230)' }} />, title: "التنظيم", desc: "جاهزة للتدقيق" }
              ].map((feature, index) => (
